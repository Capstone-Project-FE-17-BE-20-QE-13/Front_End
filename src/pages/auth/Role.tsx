  ...
  return (
    <div className="w-full h-screen xl:h-[120vh] bg-main flex justify-center items-center p-5">
      <div className="bg-white flex flex-col justify-center items-center rounded-xl h-[550px] w-3/5">
        <h1 className="font-bold text-xl text-center">Welcome to JobHuntz!</h1>
        <img src={loginImage} alt="" />
        <div className="w-full flex justify-around flex-wrap">
          <div className="flex flex-col justify-center gap-6 border border-slate-500 rounded-xl md:py-6 md:px-3 xl:py-12 xl:px-8">
        ...
        <p className="font-semibold">Already have an account? Sign In</p>
      </div>
    </div>
  );
};
